...
public class PermissionUtils {
    ...
    public interface PermissionGrant {
        void onPermissionGranted(int requestCode,boolean tickchecked);
    }
...
//        }
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            permissionGrant.onPermissionGranted(requestCode,true);
        }
    }
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        if (notGranted.size() == 0) {
            Toast.makeText(activity, "all permission success" + notGranted, Toast.LENGTH_SHORT)
                    .show();
            permissionGrant.onPermissionGranted(CODE_MULTI_PERMISSION,false);
        } else {
    ...
    public static void requestMultiPermissions(final Activity activity, PermissionGrant grant) {
        ...
        if (permissionsList.size() > 0) {
            ...
            grant.onPermissionGranted(CODE_MULTI_PERMISSION,false);
        }
    ...
    private static void shouldShowRationale(final Activity activity, final int requestCode, final String requestPermission) {
        //TODO
        showMessageOKCancel(activity, "请允许获取此权限，否则无法开启这个功能", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions,
        ...
        if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            permissionGrant.onPermissionGranted(requestCode,false);

        } else {
            //TODO hint user this permission function
            Log.i(TAG, "onRequestPermissionsResult PERMISSION NOT GRANTED");
            //TODO
            openSettingActivity(activity,  "没有此权限，无法开启这个功能");
        }
