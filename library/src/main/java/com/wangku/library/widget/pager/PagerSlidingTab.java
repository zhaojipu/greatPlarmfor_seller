...
public class PagerSlidingTab extends HorizontalScrollView {
	...
	public interface OtherTabProvider {
		 View getPageOtherView(int position);
	}
	...
	private int indicatorColor = 0xFFE4424A;//线的颜色
	private int underlineColor = 0xe4424a;
	...
	private int indicatorHeight = 1;//线的高度
	private int underlineHeight = 1;//底边线的高度
	private int dividerPadding = 12;
	private int tabPadding = 0;
	private int dividerWidth = 1;//分割线的宽度

	private int tabTextSize = 15;//标题字体的大小
	...
	private int tabBackgroundResId = 0;//标题的背景selector
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			}else if(pager.getAdapter() instanceof OtherTabProvider){
				addOtherTab(i,((OtherTabProvider) pager.getAdapter()).getPageOtherView(i));
			}else {
...
//				}
	...
	private void addOtherTab (final int position, View view){
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				textView.setTextColor(i==0?getResources().getColor(R.color.slidingtab_indicatorcolor):tabTextColor);
			}
		}
